...
public class Debug {
	...
	public static final void dump(int i) {
		log.info(String.valueOf(dumpHead()) + String.valueOf(i));
		
	}

	public static final void dump(long l) {
		log.info(String.valueOf(dumpHead()) + String.valueOf(l));
		
	}

	public static final void dump(float f) {
		log.info(String.valueOf(dumpHead()) + String.valueOf(f));
		
	}

	public static final void dump(double d) {
		log.info(String.valueOf(dumpHead()) + String.valueOf(d));
		
	}

	public static final void dump(boolean b) {
		log.info(String.valueOf(dumpHead()) + String.valueOf(b));
		
	}

	public static final void dump(char ch) {
		log.info(String.valueOf(dumpHead()) + String.valueOf(ch));
	...
	private static final void dumpServletRequest(String prefix, Object request) {
		try {
			...
			log.error("dumpServletRequest",ex);
		}
	}
	...
	private static final void dump(String prefix, int depth,
		...
		if (map == null)
			dump(prefix, "null");
		if(prefix != null && checkCircuit != null && map != null){
	...
	private static final void dump(String prefix, String str) {
		log.info(String.valueOf(prefix) + String.valueOf(str));
	...
	private static void dumpBegin(String prefix, Vector checkCircuit, Object obj) {
		...
		if (prefix.trim().endsWith(
			...
			log.info(String.valueOf(String.valueOf(prefix)).concat(" {"));
		else
			log.info(String.valueOf(String.valueOf((new StringBuffer(String
	...
	private static void dumpEnd(String prefix, Vector checkCircuit, Object obj) {
		...
		log.info(new String(cw.toCharArray()));
		log.info("}");
