...
public class CMPP30DeliverMessage extends CMPPMessage
{
    ...
    public String toString()
    {
        ...
        tmpStr = String.valueOf(String.valueOf((new StringBuffer(String.valueOf(String.valueOf(tmpStr)))).append(",MsgId=").append(String.valueOf(TypeConvert.getLong(getMsgId(), 0)))));
