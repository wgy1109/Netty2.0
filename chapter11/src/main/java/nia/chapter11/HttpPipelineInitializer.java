...
public class HttpPipelineInitializer extends ChannelInitializer<Channel> {
    ...
    protected void initChannel(Channel ch) throws Exception {
        ...
        if (client) {													
            ...
            pipeline.addLast("decoder", new HttpRequestDecoder());		// 如果是服务端，则添加 HttpRequestDecoder 以接收来自客户端的请求 
            pipeline.addLast("encoder", new HttpResponseEncoder());		// 如果是服务端，则添加 HttpResponseEncoder 以向客户端发送响应
        }
    }
}
